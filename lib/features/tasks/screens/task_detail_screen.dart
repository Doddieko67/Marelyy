...
import 'package:classroom_mejorado/features/tasks/widgets/task_detail/task_files_section.dart';
...
class _TaskDetailScreenState extends State<TaskDetailScreen>
  ...
  String _editPriority = task_utils.TaskPriority.medium.name;
  ...
  String _normalizePriority(String? priority) {
    return task_utils.TaskUtils.parseTaskPriority(priority).name;
  }
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: DropdownButtonFormField<String>(
                                  ...
                                  onChanged: (value) {
                                    setModalState(() {
                                      _editPriority = value ?? task_utils.TaskPriority.medium.name;
                                    });
                                  },
                                ),
                              ),
