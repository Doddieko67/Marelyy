...
import 'package:classroom_mejorado/Screen/AIAssistantScreen.dart';
...
import 'package:classroom_mejorado/Screen/CommunitySettingsScreen.dart';
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TabBar(
                      ...
                      tabs: [
                        _buildTab("Chat"),
                        _buildTab("Tareas"), // Traducido
                        _buildTab("IA"), // Traducido (IA por AI)
                        _buildTab("Ajustes"), // Traducido
                      ],
                      // ************ FIN DEL CAMBIO ************
                    ),
                  ),
                  ...
                  child: TabBarView(
                    ...
                    children: [
                      ...
                      CommunitySettingsScreen(
                        ...
                        communityName:
                            communityName, // Pasa el nombre ya obtenido
                      ),
                    ],
                  ),
                ),
