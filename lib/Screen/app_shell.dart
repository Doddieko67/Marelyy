// lib/screens/app_shell.dart (Corregido)
import 'package:classroom_mejorado/Screen/CommunitiesScreen.dart';
import 'package:classroom_mejorado/Screen/MyTasksScreen.dart';
import 'package:classroom_mejorado/Screen/ProfileScreen.dart';
import 'package:classroom_mejorado/navigation/tab_navigation.dart';
...
class _AppShellState extends State<AppShell> {
  ...
  final GlobalKey<NavigatorState> _tasksNavigatorKey =
      GlobalKey<NavigatorState>();
  final GlobalKey<NavigatorState> _inboxNavigatorKey =
      GlobalKey<
        NavigatorState
      >(); // Aunque no se usa en _widgetOptions, la mantenemos por consistencia si se añade en el futuro
  ...
  late final List<GlobalKey<NavigatorState>> _navigatorKeys = [
    ...
    _tasksNavigatorKey,
    // _inboxNavigatorKey, // Asegurarse que si se descomenta, haya un widget correspondiente
